...
export default class JVerification {
     ...
     *
     *       // 新增支持
     *       showWindow: boolean     // 是否显示为弹窗
     *       windowBackgroundAlpha: float, // 弹窗外侧 透明度 0~1.0，仅iOS
     *       windowCornerRadius: float,  // 弹窗圆角数值，仅iOS
     *       windowConstraintsCenterX: int,  // 窗口相对屏幕中心的x轴偏移量
     *       windowConstraintsCenterY: int,  // 窗口相对屏幕中心的y轴偏移量
     *       windowConstraintsW: int,  // 窗口宽度
     *       windowConstraintsH: int,  // 窗口高度
     *  }
     *
